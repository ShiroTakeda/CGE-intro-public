...
Time-stamp:	<2023-04-28 16:15:44 st>
...
+ chapter_15_SAM_example.xlsx
  + SAM のデータのファイルです。

+ chapter_15_SAM_example_alt.xlsx
  + SAM のデータのファイルです。

+ data_create.gms
  + データを作成するためのプログラムです。chapter_15_SAM_example.xlsx 用です。

+ data_create_alt.gms
  + データを作成するためのプログラムです。chapter_15_SAM_example_alt.xlsx 用です。
...
+ 結果をエクセルファイルに出力するには export_excel.gms と export_excel_alt.gms
  を実行します。
+ 結果は chapter_15_results.xlsx に出力されます。
