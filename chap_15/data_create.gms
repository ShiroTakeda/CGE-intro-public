...
$ontext
Time-stamp:     <2023-04-30 01:26:29 st>
First-written:  <2014/03/15>

+ japan_model.gms で利用するデータを作成するプログラム。
+ chap_15_SAM_example.xlsx から chap_15_SAM_example.gdx を作成する。
...
i=%data_name%.xlsx
o=%data_name%.gdx
par=SAM rng=SAM_adjusted!B3:BG60 rdim=2 cdim=2
$offecho
