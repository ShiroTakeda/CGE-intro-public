$title 貿易のある一地域モデル
$ontext
Time-stamp:     <2023-04-28 15:38:13 st>
First-written:  <2016/03/15>

［注］ このプログラムを実行する前に data_create.gms を実行して、
chapter_12_SAM_example.gdx というファイルを作成しておくこと。
...
set scn_ / cap_i_fex, rt_c_fex, rt_m_fex /;
...
execute_unload "one_region.gdx", results, results_pc;
