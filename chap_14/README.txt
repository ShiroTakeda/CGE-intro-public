...
Time-stamp:	<2023-04-28 15:38:23 st>
...
+ chapter_14_SAM_example.xlsx
  + SAM のデータのファイルです。
  + gov_model_A.gms と gov_model_A.gms で使う SAM が入っています。

+ chapter_14_SAM_example.gdx
...
+ export_excel.gms
  + 計算結果を chapter_14_results.xlsx に出力するためのプログラムです。

+ chapter_14_results.xlsx
  + 計算結果を出力する先です。
...
+ 結果は chapter_14_results.xlsx に出力されます。
